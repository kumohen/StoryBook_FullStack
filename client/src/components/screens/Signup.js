...
const SignUp  = ()=>{
    ...
    const uploadPic = ()=>{
        ...
        fetch("https://api.cloudinary.com/v1_1//image/",{
            method:"post",
            body:data
        })
        .then(res=>res.json())
   ...
   return (
      <div className="mycard" style={{width:"45%",marginLeft:"30%"}}>
          <div className="card auth-card input-field">
            ...
            <button className="btn "
             style={{marginLeft:"38%",height:"40px",width:"80px",backgroundColor:'green'}}
            onClick={()=>PostData()}
            >
                SignUP
            </button>
